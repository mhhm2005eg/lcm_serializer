...
#ifndef __exlcm_messg_hpp__
#define __exlcm_messg_hpp__
...
int messg::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int messg::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int messg::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t messg::getHash()
{
    static int64_t hash = static_cast<int64_t>(_computeHash(NULL));
    return hash;
}

const char* messg::getTypeName()
{
    return "messg";
}

int messg::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int messg::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int messg::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t messg::_computeHash(const __lcm_hash_ptr *)
{
